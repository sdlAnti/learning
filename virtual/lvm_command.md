...
| lvcreate	   | Создаёт логический том  --type thin-pool --poolmetasize=1G --name mythin data |
| lvdisplay	   | Выводит информацию о логическом томе |
| lvextend	   | Добавляет пространство в логический том  lvextend -L+12G /dev/yoyo/yoyo_data (-l+100%FREE) resize2fs
